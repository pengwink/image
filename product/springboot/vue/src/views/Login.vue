<template>
  <div class="wrapper">
    <div style="height: 60px; line-height: 60px; font-size: 20px; padding-left: 50px; color: #409EFF;
      background-color: rgba(0,0,0,0.5)">图片管理系统</div>
<!--    <div class="login-form" style="margin: 150px auto; background-color: #fff; width: 350px; height: 300px; padding: 20px; border-radius: 10px">-->
    <div class="login-form">
      <div style="margin: 20px 0; text-align: center; font-size: 30px; color: #cccccc "><b>登 录</b></div>
...
<!--        </el-form-item>-->
        ...
        <el-form-item style="margin: 10px 0; ">
          ...
          <el-button type="primary" plain size="small"  autocomplete="off" @click="$router.push('/register')">前往注册</el-button>
        </el-form-item>
