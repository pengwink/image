...
public class CategoriesController {
    ...
    public Result save(@RequestBody Categories categories) {
        if (categories.getId() == null) {
            //categories.setTime(DateUtil.now());
            //categories.setUser(TokenUtils.getCurrentUser().getUsername());
        }
    ...
    public Result deleteBatch(@RequestBody List<Integer> ids) {
        categoriesService.removeByIds(ids);
        return Result.success();
    }
...
//        }
        return Result.success(categoriesService.page(new Page<>(pageNum, pageSize), queryWrapper));
    }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Categories信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Categories> list = reader.readAll(Categories.class);

        categoriesService.saveBatch(list);
        return Result.success();
    }
